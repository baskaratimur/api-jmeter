...
folderName=apiCheck_$(date +"%d%m%Y")
...
./jmeter -n -t APIvisionplus-prod.jmx -l /home/ubuntu/apache-jmeter-5.5/report/"$dateTime".jtl -e -o /home/ubuntu/apache-jmeter-5.5/html/"$folderName"/"$dateTime"